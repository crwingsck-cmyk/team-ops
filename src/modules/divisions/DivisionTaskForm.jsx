...
const EMPTY = { title: "", description: "", assigneeId: "", dueDate: "", status: "todo" };

export default function DivisionTaskForm({ initial, volunteers, onSubmit, onCancel }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <Input label="任務標題" required value={form.title} onChange={(e) => setForm({ ...form, title: e.target.value })} />
